...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-nt-061-skolem-problem-996527b3-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/NT-061"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-nt-061-skolem-problem-996527b3-v1",
      "problem_contract_sha256": "a926c24b61bc9d0598a0161704b2c666d8ea8d83bbc1d4392c533771c6e9d75e",
      "problem_id": "problem:um-nt-061-skolem-problem-996527b3",
      "route_id": "route:um-nt-061-skolem-problem-996527b3-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-nt-061-skolem-problem-996527b3-source-fidelity-01",
      "graph_id": "graph:um-nt-061-skolem-problem-996527b3-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-nt-061-skolem-problem-996527b3-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-nt-061-skolem-problem-996527b3-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Can an algorithm determine if a constant-recursive sequence contains a zero?"
          },
          "statement_sha256": "1694635f1e0a872e2dbb89776065ade0612350aafd1a84090a7c1d7a14a6396d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-nt-061-skolem-problem-996527b3-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-nt-061-skolem-problem-996527b3-root",
      "route_id": "route:um-nt-061-skolem-problem-996527b3-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-nt-061-0d0bcd9aabe2",
        "url": "https://www.unsolvedmath.com/problems/NT-061"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
